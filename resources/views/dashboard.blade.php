    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="space-y-6">
                ...
                {{-- 2. ALERT: ONBOARDING / KELENGKAPAN PROFIL --}}
                @if($showOnboardingAlert)
                <div class="rounded-lg border border-orange-200 bg-orange-50 p-4 shadow-sm mb-6" role="alert">
                    <div class="flex items-start gap-4">
                        <div class="p-2 bg-white rounded-full border border-orange-100 mt-1">
                            {{-- Icon Alert --}}
                        ...
                        <div>
                            <h5 class="font-semibold text-orange-900">Mohon Perhatian!</h5>
                            <div class="text-sm text-orange-800 mt-1 space-y-1">
                                <p>Agar pengalaman belajar Anda maksimal, mohon selesaikan langkah berikut:</p>

                                <ul class="list-disc list-inside ml-1 font-medium">
                                    {{-- Cek kolom profile_completed (jika false, tampilkan pesan) --}}
                                    @if(!$user->profile_completed)
                                    <li>
                                        Lengkapi data diri.
                                        <a href="{{ route('profile.edit') }}" class="underline hover:text-orange-950 ml-1">Edit Profil &rarr;</a>
                                    </li>
                                    @endif

                                    {{-- Cek kolom must_change_password (jika true, tampilkan pesan) --}}
                                    @if($user->must_change_password)
                                    <li>
                                        Demi keamanan, segera ubah password default Anda.
                                        <a href="{{ route('profile.edit') }}" class="underline hover:text-orange-950 ml-1">Ubah Password &rarr;</a>
                                    </li>
                                    @endif
                                </ul>
                            </div>
                ...
                <div class="rounded-xl border border-gray-200 bg-white text-gray-950 shadow-sm">
                    ...
                    <div class="p-6">
                        ...
                        <div class="text-center py-6">
                            ...
                            <a href="{{ route('courses.index') }}" class="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-gray-900 text-white hover:bg-gray-900/90 h-9 px-4 py-2">
                                Lihat Katalog
                            </a>
                        </div>
                        @endif
